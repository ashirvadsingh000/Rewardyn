    ...
    <div>
       <div className="font-roboto bg-gray-100 lg:pt-28 pt-16">
          <div className="bg-blue-600 text-white text-center py-8">
            <img src="https://builtin.com/cdn-cgi/image/f=auto,fit=contain/sites/www.builtin.com/files/styles/company_logo/public/2024-03/1630619585463.jpeg" alt=" logo" className="mx-auto mb-4" />
          ...
          <div className="text-center py-8">
            ...
            <div className="bg-gray-100 p-4 rounded-lg inline-block">
              ...
              <button className="bg-orange-500 text-white py-2 px-4 rounded-full"><a href="https://www.bigcartel.com/">EARN UPTO 8% CASHBACK</a></button>
            </div>
          </div>
          <div className="bg-white py-8">
            ...
            <div className="text-center mt-8">
              <button className="bg-blue-500 text-white py-2 px-4 rounded-full"><a href="https://www.bigcartel.com/">See More Offers</a></button>
            </div>
          </div>
        </div>
    </div>
