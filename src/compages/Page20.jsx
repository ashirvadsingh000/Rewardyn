    ...
    <div>
       <div className="font-roboto bg-gray-100 lg:pt-28 pt-16">
          <div className="bg-blue-600 text-white text-center py-8">
            <img src="'https://builtin.com/cdn-cgi/image/f=auto,fit=contain/sites/www.builtin.com/files/styles/company_logo/public/2023-12/1631342988209.jpeg" alt=" logo" className="mx-auto mb-4" />
          ...
          <div className="text-center py-8">
            ...
            <div className="bg-gray-100 p-4 rounded-lg inline-block">
              ...
              <button className="bg-orange-500 text-white py-2 px-4 rounded-full"><a href="https://www.rakuten.com/">EARN UPTO 8% CASHBACK</a></button>
            </div>
          </div>
