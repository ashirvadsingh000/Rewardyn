       ...
       <div className="font-roboto bg-gray-100 lg:pt-28 pt-16">
          ...
          <div className="text-center py-8">
            ...
            <div className="bg-gray-100 p-4 rounded-lg inline-block">
              ...
              <button className="bg-orange-500 text-white py-2 px-4 rounded-full"><a href="https://www.mesho.com/">EARN UPTO 8% CASHBACK</a></button>
            </div>
          </div>
          <div className="bg-white py-8">
            ...
            <div className="text-center mt-8">
              <button className="bg-blue-500 text-white py-2 px-4 rounded-full"><a href="https://www.mesho.com/">See More Offers</a></button>
            </div>
          </div>
        </div>
    </div>
